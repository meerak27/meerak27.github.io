...
namespace UltimateReplay
{
    public class ReplayMaterial : ReplayRecordableBehaviour
    {
        ...
        protected override void OnReplayUpdate(float t)
        {
            ...
            {
                updateData.color = Color.Lerp(lastMaterialData.color, targetMaterialData.color, t);
                updateData.mainTextureOffset = Vector2.Lerp(lastMaterialData.mainTextureOffset, targetMaterialData.mainTextureOffset, t);
                updateData.mainTextureScale = Vector2.Lerp(lastMaterialData.mainTextureScale, targetMaterialData.mainTextureScale, t);
            }
