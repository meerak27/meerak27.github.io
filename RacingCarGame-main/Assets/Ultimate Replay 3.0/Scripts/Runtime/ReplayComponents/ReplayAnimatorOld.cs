...
//    public class ReplayAnimatorOld : ReplayRecordableBehaviour
//    {
//        // Types
//        /// <summary>
...
//            // Update all states
//            UpdateStates(t, updateFlags, interpolateStates);
...
//                UpdateParameters(t, updateFlags, interpolateIntParams, interpolateFloatParams);
//        }
...
//        private void UpdateStates(float t, ReplayAnimatorSerializer.ReplayAnimatorSerializeFlags flags, bool interpolate)
//        {
...
//        private void UpdateParameters(float t, ReplayAnimatorSerializer.ReplayAnimatorSerializeFlags flags, bool interpolateIntegers, bool interpolateFloats)
//        {
...
//                    updateParameter.intValue = Mathf.RoundToInt(Mathf.Lerp(lastParameter.intValue, updateParameter.intValue, t));
//                }
