...
//        private ReplayTransformOld rootTransform = null;
//        private ReplayTransformOld boneTransform = null;
...
//            rootTransform = temp0.AddComponent<ReplayTransformOld>();
//            boneTransform = temp1.AddComponent<ReplayTransformOld>();
//            boneTransform.positionFlags |= ReplayTransformOld.ReplayTransformFlags.Local;
//            boneTransform.rotationFlags |= ReplayTransformOld.ReplayTransformFlags.Local;
...
//                // Create the editor
//                Editor.CreateCachedEditor(rootTransform, typeof(ReplayTransformOldInspector), ref rootTransformEditor);
//                Editor.CreateCachedEditor(boneTransform, typeof(ReplayTransformOldInspector), ref boneTransformEditor);
...
//                        GUILayout.BeginVertical();
//                        {
//                            (rootTransformEditor as ReplayTransformOldInspector).DisplayPositionRotationScale();
...
//                        GUILayout.BeginVertical();
//                        {
//                            (boneTransformEditor as ReplayTransformOldInspector).DisplayPositionRotationScale();
...
//            if (Selection.activeGameObject != null)
//            {
//                ReplayTransformOld root = Selection.activeGameObject.GetComponent<ReplayTransformOld>();

//                if (root != null)
//                {
//                    CopyTransformFlags(root, rootTransform);

//                    ReplayTransformOld[] transforms = Selection.activeGameObject.GetComponentsInChildren<ReplayTransformOld>();

//                    // Find first child bone
//                    ReplayTransformOld bone = (transforms.Length > 0) ? transforms.FirstOrDefault(t => t != root) : null;
...
//                    ReplayTransformOld bone = Selection.activeGameObject.GetComponentInChildren<ReplayTransformOld>();
...
//        private void CopyTransformFlags(ReplayTransformOld fromTransform, ReplayTransformOld toTransform)
//        {
