...
export default function Timeline() {
 // Component to render a timeline with different dates and corresponding information

  // State variables to manage the visibility of different dates
...
<h1 id="hadi" className='heading'>Timeline</h1>
    ...
    <li>
      ...
      setdate19(true)
 // Update the state and add the "selected" class to the clicked date
      setdate20(false)
      setdate21(false)
      setdate22(false)
      setdate23(false)
      setdate24(false)
// Remove the "selected" class from other dates
 ...
 {/* ... Repeat the above structure for other dates ... */}
    </li>
    <li>
 ...
 {/* List of issues corresponding to the selected date */}
...
{/* Issue: 2003 */}
 ...
 {/* ... Repeat the above structure for other issues ... */}
